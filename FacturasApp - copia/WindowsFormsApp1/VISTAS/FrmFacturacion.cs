...
namespace WindowsFormsApp1
{
    public partial class FrmFacturacion : Form
    {
        ...
        {
            //Al presionar btnAceptar disparmos el eveto para agregar MAETRO-DETALLE. PASOS:
            //1) Validar Datos
        ...
        {
            nueva.Cliente = txtCliente.Text.ToString();
            nueva.Descuento = Convert.ToInt32(txtDescuento.Text);
            nueva.Fecha = txtFecha.Text.ToString();

            if (oDBHelper.ConfirmarFactura(nueva))
            {
